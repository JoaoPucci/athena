...
public class DocumentControllerTest {
    ...
    @Transactional
    @Test
    public void shouldCreateDocumentType_ThenDeleteItAndReturnNoContent() throws Exception {
        String uriString = "/documents/types";
        URI uri = new URI(uriString);
    ...
    @Transactional
    @Test
    public void shouldTryToDeleteRecord_ThenFailWithNoSuchElementException_AndReturn404() throws Exception {
        String uriString = "/documents/types";
        URI uri = new URI(uriString);
